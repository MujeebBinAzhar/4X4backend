...
//add stock management setting
router.post("/stock-management/add", addStockManagementSetting);

//get stock management setting
router.get("/stock-management/all", getStockManagementSetting);

//update stock management setting
router.put("/stock-management/update", updateStockManagementSetting);
